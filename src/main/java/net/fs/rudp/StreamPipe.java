...
public class StreamPipe {
    ...
    public StreamPipe(ConnInfo connInfo, final DataInputStream is, final DataOutputStream os, final int BUF_SIZE,
                      final int maxSpeed) {
        this(connInfo, is, os, BUF_SIZE, maxSpeed, null, 0);
    }

    public StreamPipe(ConnInfo ci, final DataInputStream is, final DataOutputStream os, int BUF_SIZE1, final int
            maxSpeed, final byte[] preReadData, final int preReadDataLength) {
        connInfo = ci;
